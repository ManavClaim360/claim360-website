      ...
      <div className="relative z-10 w-full max-w-2xl">
        <div className="bg-white/[0.04] border border-white/10 rounded-[28px] shadow-[0_30px_120px_rgba(2,6,23,0.55)] backdrop-blur-xl p-12 sm:p-16">
          ...
          <Link to="/" className="inline-flex items-center gap-2.5 mb-8">
            ...
            <span className="font-display text-white text-lg">Claim<span className="text-gold">360</span></span>
          </Link>

          <div className="font-display text-gold/20 leading-none mb-3 select-none" style={{ fontSize: 'clamp(72px, 20vw, 128px)' }}>
            404
          </div>
          ...
          <p className="text-white/45 text-sm leading-relaxed mb-8">
            This link is broken, outdated, or hasn&apos;t been published yet.
          </p>
