...
import { CalendarCheck, FileSearch, Send, CheckCircle } from 'lucide-react'
            ...
            {STEPS.map((step, i) => (
              ...
              >
                ...
                <div className="relative inline-block mb-6">
                  <div className="w-16 h-16 sm:w-24 sm:h-24 rounded-full bg-white dark:bg-navy-card border-2 border-slate-100 dark:border-white/10 flex items-center justify-center mx-auto shadow-lg shadow-black/5 group-hover:border-gold group-hover:shadow-gold/20 group-hover:shadow-xl transition-all duration-400">
                    <step.Icon className="w-6 h-6 sm:w-9 sm:h-9 text-navy dark:text-gold" strokeWidth={1.5} />
                  </div>
                  {/* Number badge */}
